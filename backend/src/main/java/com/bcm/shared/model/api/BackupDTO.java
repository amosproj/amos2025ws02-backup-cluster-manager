...
public class BackupDTO {
    ...
    public BackupDTO(Long id, Long clientId, Long taskId, String name, BackupState status,
    ...
    public BackupState getStatus() { return status; }
    public void setStatus(BackupState status) { this.status = status; }
