...
class NodeControllerTests {
    ...
    void syncEndpoint_callsReplaceAllOnLocalTablesService() {
        ...
        dto.setActive(List.of(new NodeDTO(1L, "Node A","10.100.179.80:9300", com.bcm.shared.model.api.NodeStatus.ACTIVE, LocalDateTime.now().minusDays(1)),
                new NodeDTO(2L, "Node B","10.100.179.80:9300", com.bcm.shared.model.api.NodeStatus.ACTIVE, LocalDateTime.now().minusDays(1))));
        dto.setInactive(List.of(new NodeDTO(3L, "Node C","10.100.179.80:9300", com.bcm.shared.model.api.NodeStatus.INACTIVE, LocalDateTime.now().minusDays(1))));
